...
<div class="container mt-5"   style="min-height: 74vh;">
  <div class="row">
    ...
    <?php if($this->session->flashdata('no_usertoken')):?>
      <div class="alert alert-danger alert-dismissible fade show" role="alert">
      <strong><?php echo $this->session->flashdata('no_usertoken');?></strong>
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
      <?php endif ?>

      <?php if($this->session->flashdata('no_page')):?>
      <div class="alert alert-danger alert-dismissible fade show" role="alert">
      <strong><?php echo $this->session->flashdata('no_page');?></strong>
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
      <?php endif ?>
